<template>
    <div class="py-10 md:py-20 bg-primary_bg">
        <!-- Removed redundant bg-primary_bg -->
        <div class="lg:mb-4">
...
import { newGames, msgTranslate, regLink, loginLink, loadLang, fetchGames } from '~/composables/globalData';

const loading = ref(true);
const emit = defineEmits(['loaded']);

// SILVER BULLET VPN FIX: Single call for both SSR and client - no duplicate onMounted call
await useAsyncData('new-game-component-data', async () => {
    await loadLang();
